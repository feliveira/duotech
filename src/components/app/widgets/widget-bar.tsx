...
export default function WidgetBar( { lang } : { lang: WidgetLangType } ) {
    return (
        <div className="select-none bg-white fixed right-0 xl:right-40 top-0 md:inset-y-0 py-2 flex md:flex-col w-full md:w-fit border-b border-b-swan md:border-t-0 h-20 md:h-full items-center lg:items-start">
